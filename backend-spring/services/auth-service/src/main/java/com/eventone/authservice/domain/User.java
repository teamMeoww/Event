package com.eventone.authservice.domain;
...
public class User {
    ...
    // Wallet projection fields (from Phase 2 reqs)
    @Indexed
    ...
    public boolean isWalletVerified() { return walletVerified; }
    public void setWalletVerified(boolean walletVerified) { this.walletVerified = walletVerified; }
